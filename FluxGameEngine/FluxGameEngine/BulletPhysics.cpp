...
//	// --------------------
//	window = glfwCreateWindow(1800, 1200, "Multiple Lights", NULL, NULL);
//	if (window == NULL)
//	{
...
//	glfwSetCursorPos(window, 1800 / 2, 1200 / 2);
//
...
//	Shader shader = Shader("1.model_loading.vs", "1.model_loading.fs");
//
//
//	// Get a handle for our "MVP" uniform
//	GLuint ProjectionMatrixID = glGetUniformLocation(shader.ID, "projection");
//	GLuint ViewMatrixID = glGetUniformLocation(shader.ID, "view");
//	GLuint ModelMatrixID = glGetUniformLocation(shader.ID, "model");
//
//	//// Load the texture
...
//		mat4 ProjectionMatrix = mat4::perspective(45.0f * toRadians, (float)1800/(float)1200, 0.1f, 100.0f);
//		mat4 ViewMatrix = mat4::lookAt(vec4(0,0,3), vec4(0,0,0), vec4(0,1,0));
//
//
//		// Dark blue background
//		glClearColor(0.0f, 0.0f, 0.4f, 0.0f);
...
//
//			mat4 model = mat4();
//			model = mat4::translate(mat4(), positions[i]);
//
//
